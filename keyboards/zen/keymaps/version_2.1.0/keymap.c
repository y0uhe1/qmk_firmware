 ...
 * |------+------+------+------+------+------+------..------+------+------+------+------+------+------|
 * |LCtrl | CONF |      |      | LOWER| SPACE| Bksp ||  TAB |  ENT | RAISE|  APP |      | CONF |RCtrl |
 * `------------------------------------------------''------------------------------------------------'
 *
 */
[L_QWERTY] = KEYMAP( \
  ...
  KC_LSFT,    KC_Z,    KC_X,    KC_C,     KC_V,    KC_B,                    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, RSFT_T(JA_ENUN),  \
  KC_LCTL,    ML_CNF,  _______, _______,  ML_LOW,  KC_SPC, KC_BSPC, KC_TAB, KC_ENT,  ML_RAI,  KC_APP,  _______, ML_CNF,  KC_RCTL           \
),
/* LOWER
 * ,-----------------------------------------.              .-----------------------------------------.
 * |      |      |      |      |      |      |              |      |      |      |      |  ^~  |  \|  |
...
[L_LOWER] = KEYMAP( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, KC_HOME, KC_UP,   KC_END,  KC_PGUP, JA_LBRC, \
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                    XXXXXXX, KC_LEFT, KC_DOWN, KC_RIGHT,KC_PGDN, JA_RBRC, \
 ...
 * |      |      |      |      |      |MsWhU |              |  F12 |      |      |      |      |      |
 * |------+------+------+------+------+------|              |------+------+------+------+------+------|
 * |      |MsWhL |MsWhR |      | MsU  |MsWhD |              |      |      |      |      |      |      |
 * |------+------+------+------+------+------|              |------+------+------+------+------+------|
 * |      |MsBt1 |MsBt2 | MsL  | MsD  | MsR  |              |      |      |      |      |      |      |
 * |------+------+------+------+------+------+------..------+------+------+------+------+------+------|
 * |      |      |      |      |      |      |  DEL ||      |      |      |      |      |      |      |
 * `------------------------------------------------''------------------------------------------------'
 * 
...
[L_RAISE] = KEYMAP( \
  ...
  _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_WH_U,                   KC_F12,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  _______, KC_WH_L, KC_WH_R, XXXXXXX, KC_MS_U, KC_WH_D,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
  _______, KC_BTN1, KC_BTN2, KC_MS_L, KC_MS_D, KC_MS_R,                   XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, \
...
[L_MAC] = KEYMAP( \
  ...
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
  _______, _______, KC_LALT, KC_LGUI, _______, _______, _______, _______, _______, _______, _______, KC_RGUI, _______, _______  \
),
/* WIN
 * ,-----------------------------------------.              .-----------------------------------------.
 * |      |      |      |      |      |      |              |      |      |      |      |      |      |
...
[L_WIN] = KEYMAP( \
  ...
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______, \
  _______, _______, KC_LGUI, KC_LALT, _______, _______, _______, _______, _______, _______, _______, KC_RALT, _______, _______  \
),
/* CONF
 * ,-----------------------------------------.              .-----------------------------------------.
